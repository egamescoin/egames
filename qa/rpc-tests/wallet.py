...
#   c) node1 mines 32 blocks, so now node 0 has 60001egamescoin, node 1 has 4250egamescoin, node2 has none.
#   d) node0 sends 601 egamescoin to node2, in two transactions (301 egamescoin, then 300 egamescoin).
