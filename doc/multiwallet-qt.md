...
In order to support loading of multiple wallets in egamescoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is egamescoin.cpp.
...
Changes to egamescoin.cpp
----------------------
egamescoin.cpp is the entry point into egamescoin-qt, and as such, will require some minor modifications to provide hooks for
