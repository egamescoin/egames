...
This mechanism has been integrated into Bitcore-Node-EGAMES which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/EGAMES-Project/insight-api-egamescoin#web-socket-api](https://github.com/EGAMES-Project/insight-api-egamescoin#web-socket-api) 
* API: [https://github.com/EGAMES-Project/insight-api-egamescoin#swifttx-transactions](https://github.com/EGAMES-Project/insight-api-egamescoin#swifttx-transactions) 
...
By default, the EGAMES Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the EGAMES Core daemon:
