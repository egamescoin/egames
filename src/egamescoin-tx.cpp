...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("eGames Core egamescoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  egamescoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded egamescoin transaction") + "\n" +
                               "  egamescoin-tx [options] -create [commands]   " + _("Create hex-encoded egamescoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded egamescoin transaction
