...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* eGames features */
        {"egamescoin", "masternode", &masternode, true, true, false},
        {"egamescoin", "listmasternodes", &listmasternodes, true, true, false},
        {"egamescoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"egamescoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"egamescoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"egamescoin", "masternodedebug", &masternodedebug, true, true, false},
        {"egamescoin", "startmasternode", &startmasternode, true, true, false},
        {"egamescoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"egamescoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"egamescoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"egamescoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"egamescoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"egamescoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"egamescoin", "mnbudget", &mnbudget, true, true, false},
        {"egamescoin", "preparebudget", &preparebudget, true, true, false},
        {"egamescoin", "submitbudget", &submitbudget, true, true, false},
        {"egamescoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"egamescoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"egamescoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"egamescoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"egamescoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"egamescoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"egamescoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"egamescoin", "checkbudgets", &checkbudgets, true, true, false},
        {"egamescoin", "mnsync", &mnsync, true, true, false},
        {"egamescoin", "spork", &spork, true, true, false},
        {"egamescoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"egamescoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use egamescoind, or the -server option to egamescoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> egamescoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:48413/\n";
}
