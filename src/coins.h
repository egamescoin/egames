...
/** 
    ...
    ****Note - for EGAMES we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of egamescoin coming in to a transaction
