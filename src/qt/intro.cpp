...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("EGAMES Core"),
     ...
     * override -datadir in the egamescoin.conf file in the default data directory
     * (to be consistent with egamescoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
