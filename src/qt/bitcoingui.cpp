                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("EGAMES Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EGAMES address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and egamescoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zEGAMES"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EGAMES Core"), this);
    aboutAction->setStatusTip(tr("Show information about EGAMES Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EGAMES"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EGAMES addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EGAMES addresses"));
    ...
    openAction->setStatusTip(tr("Open a EGAMES: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EGAMES Core help message to get a list with possible EGAMES command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EGAMES Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EGAMES network", "", count));
}
...
{
    QString strTitle = tr("EGAMES Core"); // default title
