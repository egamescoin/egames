...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted eGames to zeGames");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zeGames");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received eGames from zeGames");
    case TransactionRecord::ZerocoinSpend_Change_zeGames:
        return tr("Minted Change as zeGames from zeGames Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zeGames to eGames");
