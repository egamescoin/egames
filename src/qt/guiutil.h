...
/** Utility functions used by the EGAMES Qt UI.
 */
namespace GUIUtil
{
...
// Render EGAMES addresses in monospace font
...
// Parse "egamescoin:" URI into recipient object, return true on successful parsing
