...
public:
    ...
    void setZeGamesControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzEGAMES_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzEGAMES_clicked();
    void on_pushButtonZeGamesControl_clicked();
