...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/egamescoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/egamescoin-cli.cpp \
           src/egamescoin-tx.cpp \
           src/egamescoin.cpp \
           src/db.cpp \
           ...
           src/qt/egamescoin.cpp \
           src/qt/egamescoinstrings.cpp \
...
RESOURCES += src/qt/egamescoin.qrc src/qt/egamescoin_locale.qrc

TRANSLATIONS += src/qt/locale/egamescoin_bg.ts \
                src/qt/locale/egamescoin_de.ts \
                src/qt/locale/egamescoin_en.ts \
                src/qt/locale/egamescoin_es.ts \
                src/qt/locale/egamescoin_fi.ts \
                src/qt/locale/egamescoin_fr.ts \
                src/qt/locale/egamescoin_it.ts \
                src/qt/locale/egamescoin_ja.ts \
                src/qt/locale/egamescoin_pl.ts \
                src/qt/locale/egamescoin_pt.ts \
                src/qt/locale/egamescoin_ru.ts \
                src/qt/locale/egamescoin_sk.ts \
                src/qt/locale/egamescoin_sv.ts \
                src/qt/locale/egamescoin_vi.ts \
                src/qt/locale/egamescoin_zh_CN.ts \
                src/qt/locale/egamescoin_zh_TW.ts
