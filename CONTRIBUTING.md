Contributing to EGAMES Core
============================

The EGAMES Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EGAMES Core project, and is not to be
confused with overall EGAMES Network Protocol consensus changes.

Whether a pull request is merged into EGAMES Core rests with the project merge
...
Patches that change EGAMES consensus rules are considerably more involved than
...
Where a patch set proposes to change the EGAMES consensus, it must have been
...
The project leader is the release manager for each EGAMES Core release.
